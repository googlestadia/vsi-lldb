...
{
    /// <summary>
    /// Interface mirrors the SBTarget API as closely as possible.
    /// </summary>
    public interface SbTarget
    {
        /// <summary>
        ...
        /// </summary>
        SbBreakpoint BreakpointCreateByLocation(string file, uint line);

        /// <summary>
        /// Set breakpoints at all functions that match the specified symbol name.
        /// </summary>
        SbBreakpoint BreakpointCreateByName(string symbolName);

        /// <summary>
        /// Set a breakpoint at the specified memory address.
        /// </summary>
        SbBreakpoint BreakpointCreateByAddress(ulong address);

        /// <summary>
        /// Returns the existing breakpoint that has the given id.
        /// </summary>
        SbBreakpoint FindBreakpointById(int id);

        /// <summary>
        /// Delete the watchpoint with |breakpointId|. Return true if such watchpoint is found and
