...
{
    [TestFixture]
    class RegistrationContextStubTests
    {
        ...
        [Test]
        public void TwoKeysSameName()
        {
            const string keyName = "key1";
            registrationContextStub.CreateKey(keyName);
            Assert.Throws<ArgumentException>(() => registrationContextStub.CreateKey(keyName),
