...
namespace YetiVSI.Test.LaunchApi
{
    ...
    {
        static readonly string _thirdPartyRoot =
            Path.Combine(YetiConstants.RootDir, YetiConstants.ThirdPartyTestAssemblyRelativeRoot);
        static readonly string _sampleDir = Path.Combine(_thirdPartyRoot,
                                                         @"YetiVSI.Tests\LaunchApi\");
